...
Purpose: local source-of-truth notes for the standalone curriculum mapping page at `curriculum-workbench/curriculum-map.html`.
...
- `curriculum-workbench/cc_standards_mapping.xlsx`
- `curriculum-workbench/advanced_extensions_cc.xlsx`
...
3. Refresh the embedded row data inside `curriculum-workbench/curriculum-map.html`
