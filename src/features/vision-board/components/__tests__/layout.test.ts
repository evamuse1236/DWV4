...
import type { VisionBoardCard, CardType, CardSize, ColorVariant } from "@/features/vision-board/hooks/useVisionBoard";
import { ALLOWED_SIZES } from "@/features/vision-board/hooks/useVisionBoard";
import { computeVisionBoardLayout, GRID_COLS, spanForSize } from "@/features/vision-board/components/layout";
